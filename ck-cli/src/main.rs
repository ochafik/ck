...
struct Cli {
    ...
    #[arg(
        long = "model",
        value_name = "MODEL",
        help = "Embedding model to use for indexing (bge-small, nomic-v1.5, jina-code, mxbai-xsmall, static-retrieval-en, static-multilingual) [default: bge-small]. Only used with --index."
    )]
    model: Option<String>,
